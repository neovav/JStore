var JStore = function()
 {
     ...
     this.enc = function(str){return window.btoa(unescape(encodeURIComponent(str)));};
     ...
     this.dec = function(str){return decodeURIComponent(escape(window.atob(str)));};
